...
exports.SaleModule = SaleModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([sale_entity_1.Sale]), customer_module_1.CustomerModule],
        controllers: [sale_controller_1.SaleController],
        providers: [sale_services_1.SaleService],
        exports: [sale_services_1.SaleService]
    })
], SaleModule);
